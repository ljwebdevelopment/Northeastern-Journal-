...
export const categories: Category[] = [
  ...
  { slug: "essays", name: "Essays", description: "Long-form inquiry — an idea followed wherever it leads." },
  { slug: "personal-essay", name: "Personal Essay", description: "First-person writing on a life as it was actually lived." },
  { slug: "reflections", name: "Reflections", description: "Shorter meditations on place, season, and the passage of time." },
  { slug: "memoir", name: "Memoir", description: "Remembered lives, told by the people who lived them." },
  { slug: "criticism", name: "Criticism", description: "Close readings of the art, books, and ideas in circulation." },
  { slug: "poetry", name: "Poetry", description: "Verse from our contributors and the wider community." },
